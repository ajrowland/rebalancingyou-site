      ...
      <div class="header__top">
        <div class="container">
          <ul class="header__social">
            <li>
              <a href="https://www.instagram.com/rebalancingyou/" title="Visit me on Instagram">
            ...
            <li>
              <a href="https://www.facebook.com/rebalancingyou/" title="Visit me on Facebook">
                <svg viewBox="0 0 512 512" preserveAspectRatio="xMidYMid meet">
                  <path
      ...
      <div class="header__main">
        <div class="container">
          <h1 itemprop="name">
            <a href="/" title="Home">
              Rebalancing You
              <span itemprop="jobTitle">Emma Rowland Nutrition</span>
            </a>
          </h1>
          ...
          <ul class="header__nav">
            ...
            <li>
              <g-link to="/recipes">Recipes</g-link>
            </li>
            <li>
              <g-link to="/sign-up" class="button">Sign up</g-link>
            </li>
          </ul>
        </div>
      </div>
